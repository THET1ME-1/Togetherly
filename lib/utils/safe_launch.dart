...
/// `dgis` и `yandexmaps` — карты из воспоминания. Пока их тут не было, кнопка
/// 2ГИС не доходила до системы вовсе: схема отсекалась своей же проверкой,
/// причём молча, ещё до разговора с Android (жалоба 14.08.2026). Объявления
/// схемы в манифесте и в `LSApplicationQueriesSchemes` мало — барьера три, и
/// снимать их надо все сразу.
const _knownSchemes = {
  'http',
  'https',
  'mailto',
