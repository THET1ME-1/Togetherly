...
class MapPalette {
  ...
  /// Суша на глобусе. На плоской карте сушу выдают дороги и подписи, а на
  /// шаре их нет: бледная суша сливалась с фоном вокруг шара, и моря,
  /// окружённые ею, читались материками — «мы в середине океана» (жалоба
  /// 19.09.2026). Поэтому на шаре суша — вода, наполовину уведённая в заливку
  /// темы: дальше от фона, чем вода, в обеих яркостях. На развёртке цвет
  /// плавно переходит в [land].
  Color get globeLand => mixColor(water, thread, .5);
