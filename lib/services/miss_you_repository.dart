...
class MissYouRepository {
  ...
  /// Счётчики пары разово, без подписки.
  ///
  /// Нужны, когда экран возвращается на передний план: живое событие могло
  /// прийти, пока поток пересоздавался, и человек видел старое число (жалоба
  /// 16.08.2026 — «вышел на главную, там прежний счёт»).
  Future<Map<String, int>> counts(String groupId) =>
      _data.getMissYouCounts(groupId);
