...
/// Подарок Togetherly+ партнёру через биллинг магазина (Google Play — опция
/// `gift`, App Store Connect — расходуемая покупка; оба заведены 24.08.2026).
///
/// Товар отдельный и РАСХОДУЕМЫЙ, а не тот же [kPlusProductId]: разовую
/// покупку магазины не дают купить второй раз, и владелец Плюса не смог бы
/// подарить его партнёру вовсе. Передавать купленное на чужой аккаунт ни Play,
/// ни App Store не умеют — доступ по чеку открывает наш сервер тому, кого
/// выбрали в приложении.
const String kGiftProductId = 'togetherly_plus_gift';
