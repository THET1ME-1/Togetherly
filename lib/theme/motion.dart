...
abstract final class Motion {
  ...
  ///
  /// Перелёт видно только у контроллера с `upperBound` выше единицы: обычный
  /// диапазон 0…1 срезает как раз ту часть пути, ради которой пружину и
  /// берут, и движение становится обычным подъёмом.
  ...
  /// Насколько пружина [spatial] проскакивает цель — 8% пути.
  ///
  /// При входе блока на 24 точки это две точки перелёта: заметно глазу и не
  /// превращается в подпрыгивание. Число нужно контроллерам как `upperBound`.
  static const double spatialOvershoot = 1.1;
